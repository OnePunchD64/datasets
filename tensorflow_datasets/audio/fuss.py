...
@inproceedings{fonseca2019freesound,
  title = {Freesound Datasets: A Platform for the Creation of Open Audio Datasets},
  author = {Eduardo Fonseca and Jordi Pons and Xavier Favory and Frederic Font Corbera and Dmitry Bogdanov and Andr\{'e}s Ferraro and Sergio Oramas and Alastair Porter and Xavier Serra},
...
class Fuss(tfds.core.GeneratorBasedBuilder):
  ...
  def _split_generators(self, dl_manager):
    ...
    splits = []
    for k in ["train", "eval", "validation"]:
      splits.append(
